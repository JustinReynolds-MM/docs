...
10. **Add images to tweets when possible/it makes sense**. Images increase engagement. When prompted, click the icon in the lower left-hand corner below to add an image to your tweet. As a general rule, avoid GIFs, as they tend to be unprofessional.

.. image:: ../images/mattermost-twitter.png
